            ...
            <div className={styles.modal}>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
                    ...
                    <div className={styles.field}>
                        ...
                        <input {...register('director', { required: 'Director required' })} />
                        {errors.director && <span className={styles.error}>{errors.director.message}</span>}
                    </div>

                    <div className={styles.row}>
                        <div className={styles.field}>
                            <label>Release year</label>
                            <input type="number" {...register('release_year', {
                                required: 'Year required',
                                min: { value: 1895, message: 'Invalid year' }
                            })} />
                            {errors.release_year && <span className={styles.error}>{errors.release_year.message}</span>}
                        </div>
                    ...
                    <div className={styles.field}>
                        ...
                        <select {...register('category_id', { required: 'Category required' })}>
